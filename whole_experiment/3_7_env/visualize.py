...
# 保存したモデルパラメータの読み込み
agent.vae.load_state_dict(torch.load('./vae_last.pth'))
agent.lbn.load_state_dict(torch.load('./lbn_last.pth'))
agent.controller.load_state_dict(torch.load('./controller_last.pth'))
agent.speaker.load_state_dict(torch.load('./speaker_last.pth'))
